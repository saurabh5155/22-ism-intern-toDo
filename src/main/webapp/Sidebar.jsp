<div class="nav-header">
	<a href="index.html" class="brand-logo"> <svg class="logo-abbr"
			width="55" height="55" viewBox="0 0 55 55" fill="none"
...
<div class="dlabnav">
	<div class="dlabnav-scroll mm-active ps ps--active-y">
		<ul class="metismenu mm-show" id="menu">
			<li><a href="AddTask.jsp" class="" aria-expanded="false">
					<i class="fas fa-user-check"></i> <span class="nav-text">Add Task</span>
			</a></li>
			
			<li><a href="ListTaskController" class="" aria-expanded="false">
					<i class="fas fa-clone"></i> <span class="nav-text">List Task</span>
			</a></li>
		...
		<div class="ps__rail-y" style="top: 0px; height: 603px; right: 0px;">
			<div class="ps__thumb-y" tabindex="0"
				style="top: 0px; height: 500px;"></div>
		</div>
	</div>
</div>